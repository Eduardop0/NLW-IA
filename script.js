...
const perguntarAI = async (question, game, apiKey) => {
    ...
    const pergunta = `
       ...
       - Nunca responda itens que você não tenha certeza que
       existe no patch atual
       
       ## Resposta
       -Economize na resposta e responda no máximo 500
       caracteres. 
       ...
       resposta: A build mais atual é: /n/n **Itens**/n/n coloque
       os itens aqui/n/n**Runas:**/n/n
